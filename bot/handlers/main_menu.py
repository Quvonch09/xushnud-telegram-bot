...
async def handle_raqam_olish(message: Message):
    text = (
        "🤗 Telegram uchun tayyor hisoblar, tez orada qo'shiladi.\n"
        "🛒 Agar sizga spam bo'lmagan ishonchli hisob kerak bo'lsa admin orqali xarid qilishingiz mumkin."
    )
...
async def handle_hamkorlik(message: Message):
    text = (
...
@main_menu_router.message(F.text == "❌ Bekor qilish")
